                                        ...
                                        <form action="{{route('order.new')}}" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if (isset($customer->name))
                                                    <input type="text" id="name" name="name" value="{{$customer->name}}" disabled placeholder="Full name">
                                                @else   
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="email" name="email" value="{{$customer->email}}" disabled placeholder="Email">
                                                @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="mobile" id="mobile" name="mobile" value="{{$customer->mobile}}" disabled >
                                                @else    
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="delivery_address" name="delivery_address" rows="2" placeholder="Delivery Address." required></textarea>
                                    ...
                                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                            <form action="{{url('/pay')}}" method="POST">
                                                ...
                                                <div class="mb-4">
                                                    <input type="radio" checked id="checkbox1" value="online" name="payment_type">
