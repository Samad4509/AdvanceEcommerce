...
<main class="main-wrapper ">
    ...
    <div class="axil-product-cart-area axil-section-gap">
            <div class="container">
                <div class="axil-product-cart-wrap cart-update">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="product-quantity" data-title="Qty">
                                        <form action="{{route('cart.update', $cartProduct->rowId)}}" method="POST" class="product_data">
                                            @csrf
                                            <input type="hidden" value="{{$cartProduct->id}}" class="prod_id">
                                            <input type="hidden" value="{{$cartProduct->rowId}}" class="id">
                                            <div class="pro-qty">
                                                <input type="number" name="qty" value="{{$cartProduct->qty}}" min="1" value="1" class="quantity-input">
                                            </div>
